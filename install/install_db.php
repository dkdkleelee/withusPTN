...
// WITHUS 재설치에 체크하였거나 GONPLAN가 설치되어 있지 않다면
if ($g5_install || $is_install === false) {
    ...
    include_once('./gonplan_alter.php');
}
...
if ($g5_install || $is_install === false) {
	...
	//  ('1010','자유게시판','{$currentip}/main/board.php?bo_table=free','self',1,1,1,'',NULL),
	//  ('1020','공지사항','{$currentip}/main/board.php?bo_table=notice','self',1,1,1,'',NULL),
	...
	(2, '1010', '자유게시판', 'http://admin.withus.co.kr/main/board.php?bo_table=free', 'self', 1, 1, 1, '', 2),
	(3, '1020', '공지사항', 'http://admin.withus.co.kr/main/board.php?bo_table=notice', 'self', 1, 1, 1, '', 2),
	(4, '20', '랜딩', '#', 'self', 1, 1, 1, 'fas fa-plane-arrival', 2),
	(5, '2010', '정상DB', 'http://admin.withus.co.kr/biz/landing/land_list.php', 'self', 1, 1, 1, '', 2),
	(6, '2020', '불량DB', 'http://admin.withus.co.kr/biz/landing/land_err_list.php', 'self', 1, 1, 1, '', 2),
	(7, '30', '페이지', '#', 'self', 1, 1, 1, 'fas fa-save', 4),
	(8, '3010', '페이지관리', 'http://admin.withus.co.kr/biz/page/page_list.php', 'self', 1, 1, 1, 'fas fa-save', 4),
	(9, '3020', '스크립트관리', 'http://admin.withus.co.kr/biz/page/page_script_list.php', 'self', 1, 1, 1, 'fas fa-save', 4),
	(10, '40', '디자인', 'http://admin.withus.co.kr/biz/design/design_list.php', 'self', 1, 1, 1, 'fas fa-palette', 4),
	(11, '50', '고객사', '#', 'self', 1, 1, 1, 'fas fa-handshake', 4),
	(12, '5010', '고객사관리', 'http://admin.withus.co.kr/biz/partner/partner_list.php', 'self', 1, 1, 1, '', 4),
	(13, '5020', '가입대기', 'http://admin.withus.co.kr/biz/partner/partner_signup_list.php', 'self', 1, 1, 1, '', 4),
	(14, '60', '인사관리', '#', 'self', 1, 1, 1, 'fas fa-user', 4),
	(15, '6010', '부서별직원', 'http://admin.withus.co.kr/biz/hr/hr_deptemp_list.php', 'self', 1, 1, 1, '', 4),
	(16, '6020', '가입대기', 'http://admin.withus.co.kr/biz/hr/hr_signup_list.php', 'self', 1, 1, 1, '', 4);
    ";
    sql_query($sql, true, $dblink);
    ...
    //depart 임시
    $sql = "
    INSERT INTO {$table_prefix}crm_depart (deptno, deptnm, parent_deptno, use_yn, insert_date, update_date, insert_user, update_user) VALUES
    (1, '위드어스', NULL, 'Y', NULL, '2022-12-14 16:21:58', '', ''),
	(2, 'DB팀', 1, 'Y', NULL, '2022-12-21 10:30:45', '', ''),
	(3, 'DB부-건희', 2, 'Y', NULL, '2022-12-21 10:30:45', '', ''),
	(4, 'DB부-기공', 2, 'Y', NULL, '2022-12-21 10:30:45', '', ''),
	(5, 'DB부-보근', 2, 'Y', NULL, '2022-12-21 10:30:45', '', ''),
	(6, 'DB부-승원', 2, 'Y', NULL, '2022-12-21 10:30:45', '', ''),
	(7, '키워드팀', 1, 'Y', NULL, '2022-12-21 10:31:23', '', ''),
	(8, '키워드부-경식', 7, 'Y', NULL, '2022-12-21 10:31:23', '', ''),
	(9, '키워드부-민규', 7, 'Y', NULL, '2022-12-21 10:31:23', '', ''),
	(10, '개발팀', 1, 'Y', NULL, '2022-12-21 10:31:23', '', ''),
	(11, '개발부-동기', 10, 'Y', NULL, '2022-12-21 10:31:23', '', NULL),
	(12, '인사팀', 1, 'Y', NULL, '2022-12-21 10:31:23', '', NULL),
	(13, '인사부-기연', 12, 'Y', NULL, '2022-12-21 10:31:23', '', NULL);
    ";
    sql_query($sql, true, $dblink);
