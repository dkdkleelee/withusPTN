...
CREATE TABLE `g5_crm_page` (
  ...
  `pg_api_add_param` varchar(100) DEFAULT NULL,
  `pg_api_success` varchar(20) DEFAULT NULL,
  `pg_api_fail` varchar(20) DEFAULT NULL,
  `pg_api_duplicate` varchar(20) DEFAULT NULL,
