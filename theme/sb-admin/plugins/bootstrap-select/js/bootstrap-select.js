...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    noneSelectedText: '미선택',
    noneResultsText: 'No results matched {0}',
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? '{0} item selected' : '{0} 선택됨';
    },
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? '선택가능 초과 ({n} item max)' : '선택가능 초과 ({n} 개 MAX)',
        (numGroup == 1) ? 'Group 선택가능 초과 ({n} item max)' : 'Group 선택가능 초과 ({n} 개 MAX)'
      ];
    },
    selectAllText: '전체선택',
