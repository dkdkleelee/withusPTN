                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>이름</label>
                                <input type="text" id="userName" name="userName" class="form-control border-info" value="<?php echo $resultOne['userName'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><code>연락처*</code></label>
                                <input type="text" id="phone" name="phone" class="form-control border-info" value="<?php echo $resultOne['phone'] ?>" oninput="telHyphen(this);" minlength="13" maxlength="13" pattern=".{13,13}" required  disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목1</label>
                                <input type="text" id="userData1" name="userData1" class="form-control" value="<?php echo $resultOne['userData1'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목2</label>
                                <input type="text" id="userData2" name="userData2" class="form-control" value="<?php echo $resultOne['userData2'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목3</label>
                                <input type="text" id="userData3" name="userData3" class="form-control" value="<?php echo $resultOne['userData3'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목4</label>
                                <input type="text" id="userData4" name="userData4" class="form-control" value="<?php echo $resultOne['userData4'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목5</label>
                                <input type="text" id="userData5" name="userData5" class="form-control" value="<?php echo $resultOne['userData5'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목6</label>
                                <input type="text" id="userData6" name="userData6" class="form-control" value="<?php echo $resultOne['userData6'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목7</label>
                                <input type="text" id="userData7" name="userData7" class="form-control" value="<?php echo $resultOne['userData7'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목8</label>
                                <input type="text" id="userData8" name="userData8" class="form-control" value="<?php echo $resultOne['userData8'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>항목9</label>
                                <input type="text" id="userData9" name="userData9" class="form-control" value="<?php echo $resultOne['userData9'] ?>" disabled>
                            </div>
                        </div>
                    </div>
