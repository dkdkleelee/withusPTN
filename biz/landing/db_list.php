...
td input[type="text"], td select {
    width: 100%; /* input 및 select를 100%로 확장하여 td에 맞춤 */
    box-sizing: border-box; /* 테두리와 안쪽 여백 포함하여 크기 지정 */
}
            ...
            <div class="col-12">
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">DB (<?php echo number_format($total_count) ?>건)</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-sm-row flex-column justify-content-sm-between">
                                <div class="d-flex justify-content-center mb-2 mb-sm-0">
                                    <div class="btn-group xs-100">
                                        ...
                                        <?php echo $ptn_html ?> 
                                        <button type="submit" form="listForm" class="btn btn-primary btn-sm border border-dark" name="act_button" value="선택수정"><i class="fas fa-eraser"></i>수정</button>
                                    ...
                                    <div class="btn-group xs-100">
                                        ...
                                        <form class="form-inline my-2 my-lg-0 ng-pristine ng-valid">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="search_phone" name="stx_phone" value="<?php echo $stx_phone ?>" class="form-control sm-1" placeholder="연락처 검색" aria-label="검색어" oninput="telHyphen(this);" minlength="13" maxlength="13">
                                            </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="search_name" name="stx_name" value="<?php echo $stx_name ?>" class="form-control sm-1" placeholder="이름 검색" aria-label="검색어" minlength="1" maxlength="10">
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-default">유입</span>
                                                </div>
                                                <input type="text" id="stx_pg_inflow" name="stx_pg_inflow" value="<?php echo $stx_pg_inflow ?>" class="form-control sm-1" style="width:100px" placeholder="유입검색" aria-label="검색어" minlength="1" maxlength="20">
                                            </div>
                                            <?php } ?>

                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-default">일자</span>
                                                </div>
                                                <input type="text" id="search_fromto" name="stx_fromto" value="<?php echo $stx_fromto ?>" class="form-control sm-1" style="width:210px">
                                            </div>
                                    ...
                                    <div class="table-responsive" id="scrollableTable" style="position: relative;">                                       
                                        <table id="tbl_land" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                            ...
                                            <tr style="<?php echo $row['db_status'] == '2' || $row['db_status'] == '3' ? 'text-decoration: line-through; text-decoration-color: red;' : '' ?>">
                                                ...
                                                ?>
                                                <td>
                                                    <select name="db_status[]" id="db_status" class="custom_select border" style="color:<?php echo $color; ?>">
                                                    <?php
                                                    if ($ptn_status_custom == "basic") {
                                                        echo '<option value="" style="color:black" '.get_selected($row['db_status'], '').'>대기</option>';
                                                        echo '<option value="1" style="color:orange" '.get_selected($row['db_status'], '1').'>부재</option>';
                                                        echo '<option value="2" style="color:brown" '.get_selected($row['db_status'], '2').'>결번</option>';
                                                        echo '<option value="3" style="color:red" '.get_selected($row['db_status'], '3').'>거절</option>';
                                                        echo '<option value="4" style="color:blue" '.get_selected($row['db_status'], '4').'>승인</option>';
                                                        echo '<option value="5" style="color:orchid" '.get_selected($row['db_status'], '5').'>리콜</option>';
                                                        echo '<option value="6" style="color:green" '.get_selected($row['db_status'], '6').'>가망</option>';
                                                        echo '<option value="7" style="color:green" '.get_selected($row['db_status'], '7').'>완료</option>';
                                                    } else {
                                                        if (!empty($ptn_status_custom)) {
                                                            $customOptions = explode('||', $ptn_status_custom);
                                                            foreach ($customOptions as $option) {
